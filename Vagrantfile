...
Vagrant.configure("2") do |config|
  ...
  config.vm.box = "iv_devbox_6.0_i386.v1"
  ...
  config.vm.synced_folder "db", "/var/lib/mysql", :owner => 'mysql', :group => 'mysql'
  config.vm.synced_folder 'perspectives', "/opt/ivillage", :owner => 'www', :group => 'www'
